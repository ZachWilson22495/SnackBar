...
namespace SnackBar.Migrations
{
    ...
    [Migration("20220124063014_TreatAccount")]
    partial class TreatAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SnackBar.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("SnackBar.Models.TreatFlavor", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SnackBar.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SnackBar.Models.TreatFlavor", b =>
                {
                    b.HasOne("SnackBar.Models.Flavor", "Flavor")
                        .WithMany("JoinEntities")
                        .HasForeignKey("FlavorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SnackBar.Models.Treat", "Treat")
                        .WithMany("JoinEntities")
